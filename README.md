...
2. [Install Arabic Language Pack](#2-how-to-install-hungarian-language-pack)
3. [How to active Arabic language pack](#3-how-to-active-hungarian-language-pack)
...
## 3. How to active Arabic language pack {#active}
